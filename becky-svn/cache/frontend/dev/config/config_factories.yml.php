...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Applications/MAMP/htdocs/bbs/becky-svn/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Applications/MAMP/htdocs/bbs/becky-svn/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Applications/MAMP/htdocs/bbs/becky-svn/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Applications/MAMP/htdocs/bbs/becky-svn/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/Applications/MAMP/htdocs/bbs/becky-svn/apps/frontend/template',
)));

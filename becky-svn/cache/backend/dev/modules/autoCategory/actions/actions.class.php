...
class autoCategoryActions extends sfActions
{
  ...
  public function executeIndex(sfWebRequest $request)
  {
    ...
    $this->hasFilters = $this->getUser()->getAttribute('Category.filters', $this->configuration->getFilterDefaults(), 'admin_module');
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('model' => 'Category'));
    try
    {
      // validate ids
  ...
  protected function setSort(array $sort)
  {
	...
	{
	  $this->category = Doctrine::getTable('Category')->find($request->getParameter('id'));

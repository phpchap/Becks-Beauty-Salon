<div class="sf_admin_list ui-grid-table ui-widget ui-corner-all ui-helper-reset ui-helper-clearfix">
  ...
  <table>
    <caption class="fg-toolbar ui-widget-header ui-corner-top">
        ...
        <?php echo link_to(UIHelper::addIconByConf('reset') . __('Reset', array(), 'sf_admin'), 'category_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'fg-button ui-state-default fg-button-icon-left ui-corner-right')) ?></span>
      </div>
            <h1><span class="ui-icon ui-icon-triangle-1-s"></span> <?php echo __('List of Treatment Categories', array(), 'messages') ?></h1>
    </caption>
    <tbody>
  ...
  <table>
    <caption class="fg-toolbar ui-widget-header ui-corner-top">
        ...
        <?php echo link_to(UIHelper::addIconByConf('reset') . __('Reset', array(), 'sf_admin'), 'category_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'fg-button ui-state-default fg-button-icon-left ui-corner-right'.$isDisabledResetButton)) ?></span>
      </div>
            <h1><span class="ui-icon ui-icon-triangle-1-s"></span> <?php echo __('List of Treatment Categories', array(), 'messages') ?></h1>
    </caption>
    ...
    <tbody>
      <?php foreach ($pager->getResults() as $i => $category): $odd = fmod(++$i, 2) ? ' odd' : '' ?>

...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
          <form action="<?php echo url_for('category_collection', array('action' => 'batch')) ?>" method="post" id="sf_admin_content_form">
      ...
      <?php include_partial('Category/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper, 'hasFilters' => $hasFilters)) ?>
